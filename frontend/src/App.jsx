  ...
  return (
    <div className="z-[-1] w-full overflow-hidden flex items-center flex-col  pb-10">
      <div className='w-[100%] h-12 py-4 pr-3 absolute justify-end gap-2 flex items-center cursor-pointer z-50 max-w-[1200px]'>
        ...
        <div id='Panel' className='flex z-[1] gap-6 flex-wrap max-w-[1300px] pt-[6rem] pb-[2rem]  justify-center'>
            {cards==null ?  
            <span>
                  <div className=' w-[200px] h-[200px] bg-jasmine flex-col shadow-4xl flex justify-center text-[#2D2A2A] items-center gap-2'>  
                  <svg className='animate-spinning' width="101" height="101" viewBox="0 0 101 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      { 
      hasToShow && 
        <button className=' bg-jasmine relative flex justify-center items-center  w-[40px] sm:w-[70px] sm:h-[70px] h-[40px] rounded-sm text-[#000] text-[8rem] text-center' type="button" onClick={() => receber()}>
