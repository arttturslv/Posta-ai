...
export default function InputEscrita({trash, setTrashContent}) {
    ...
    <div className={'h-auto w-[90vw] max sm:w-[500px] md:w-[500px] relative px-10 py-5 text-[#2D2A2A] flex flex-col gap-1 shadow-2xl bg-[#DAC285] '}>
        <div> 
            ...
            <input onChange={handleChange} id="Author" type="text" maxLength={20} className=" w-full ps-1 md:ps-8 h-[50%] text-[32px] md:text-[42px] placeholder-[#704747] focus:outline-none focus:bg-white border-[#DC9C64] border-4 focus:border-[#DC9C64] rounded-lg bg-[#E78B61]" placeholder={authorHolder} />
        </div>
        <div> 
